...
export default {
	...
	methods: {
		...
		errorMessage(value) {
			...
			return this.errorMessageEmptyInclusao || value ? '' : 'Obrigatório';
		...
		erroIncluirCnaeTipologia(codigosCnaes) {
			...
			let message = ERROR_MESSAGES.relacaoCnaeTipologia.adicionarValores + "Já existe uma relação com a mesma combinação " +
