<template lang="pug">
	...
	v-form(ref="pergunta")
		v-row
			v-col.pb-0(cols="12")
				v-label Pergunta
				v-text-field#QA-input-pergunta(
					outlined,
					color="#E0E0E0",
					:placeholder="placeholder"
					v-model="pergunta.texto",
					@click.native="resetErrorMessage",
					:error-messages="errorMessage(pergunta.texto)"
					required,
					dense
				)
			v-col(cols="12")
		...
		v-row
			v-col#form-actions.d-flex.flex-row.align-center.justify-end(cols="12")
